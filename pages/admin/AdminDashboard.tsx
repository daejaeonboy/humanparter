...
const navItems: NavItem[] = [
  ...
  },
  {
    path: '/admin/company',
    label: '회사소개 비주얼 관리',
    description: '회사소개 공통 비주얼과 요약 콘텐츠 관리',
    icon: Building2,
  },
  {
    path: '/admin/public-visuals',
    label: '공개 비주얼 관리',
    description: '상단 배너와 메가 메뉴 비주얼 관리',
    icon: ImageIcon,
  },
  {
    path: '/admin/products',
  ...
  },
  {
    path: '/admin/cases',
    label: '고객사례 관리',
    description: '설치사례 등록, 수정, 카테고리 관리',
    icon: ImageIcon,
  },
  {
    path: '/admin/bookings',
    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          주요 운영 메뉴를 빠르게 이동할 수 있도록 정리했습니다. 아래 바로가기를 선택해 필요한 작업을 진행하세요.
        </p>
      </section>
  ...
  return (
    <div className="min-h-screen bg-[#f5f7fb]">
      ...
      <div className="flex">
        ...
        <main key={location.pathname} className="min-h-[calc(100vh-72px)] flex-1 p-6">
          <Outlet />
        </main>
      </div>
    </div>
